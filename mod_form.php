    ...
    public function definition() {
        ...
        if (!empty($trackedmodules)) {
            ...
            foreach ($trackedmodules as $cm) {
                ...
                $mform->addElement('html', html_writer::start_div('modinfo-wrapper'));
                // Wrapper for this module's filemanager elements
                $mform->addElement('html', html_writer::start_div('imagefile-wrapper'));
