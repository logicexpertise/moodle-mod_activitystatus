            ...
            if (isset($item->module)) {
                ...
                if (empty($mod->available)) {
                    ...
                    switch ($state) {
                        ...
                        // From Totara lib/completionlib.php:
                        // TOTARA: This isn't used anywhere in Totara, and hasn't since 2.2.0 at least
                        // Not used in current versions of Moodle either
